...
#se deben ver los puntos azules mas claros que se observan en las esquinas
#se eliminarion todos los picos mayores que un valor, como cortar todas las montanas desde cierta altura.
